...
my_validation_data = load_training_dataSet('Datasets/System_wise_clone_features/System_' + str(systemID) + '.csv')
...
for n in range(0, samples):
   ...
   manual_validation_res = getManualValidationResult2('Datasets/User_Validation_Results/System'+str(systemID)+'/', fileCount,
                                                      my_validation_data[n][0])
...
print ("============================== System "+ str(systemID) +" =========================")
print ("Samples :" + str(samples) )
print ("Proposed Testing Elapsed Time: " + str(end_time - start_time) )
